...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <SidebarIcon className='size-6 text-muted-foreground  group-hover:text-neutral-200' />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar='group'
      className={cn(
        'relative mt-1 flex w-full min-w-0 flex-col px-3 group-data-[collapsible=icon]:px-1.5 ',
        className
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-8 shrink-0 items-center rounded-md px-2 text-xs uppercase text-sidebar-foreground/60 outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-5 [&>svg]:shrink-0',
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      'mx-3.5 flex min-w-0 translate-x-px flex-col gap-1.5 border-l border-sidebar-border px-2.5 py-0.5',
      'group-data-[collapsible=icon]:hidden',
      className
    )}
    {...props}
